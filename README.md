...
Each top-level example under [`examples/`](examples/) is documented independently.

- [`examples/todo-ddd/README.md`](examples/todo-ddd/README.md): small DDD-oriented example with multiple handlers and filtered projections
- [`examples/game-server/README.md`](examples/game-server/README.md): game state coordination with subscribers and domain services
- [`examples/event-sourced-wallet/README.md`](examples/event-sourced-wallet/README.md): event sourcing and projections
- [`examples/workflow-employee-onboarding/README.md`](examples/workflow-employee-onboarding/README.md): workflow orchestration and rollback
- [`examples/saga-order-fulfillment/README.md`](examples/saga-order-fulfillment/README.md): saga-style distributed coordination
...
The IoC helpers in [`ioc/`](ioc/) are intentionally small. They are meant to support composition, not to hide the library model.
